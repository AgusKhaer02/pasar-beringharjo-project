		...
		<div class="container-login100" style="background-image: url(<?= base_url('assets-toko-login/images/bg-01.jpg') ?>);">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<?php if (session('success')) : ?>
					<span class="login100-form-title p-b-49">Konfirmasi Email Berhasil</span>
					<p>Anda bisa lanjut ke halaman berikutnya</p>
					<div class="my-5"></div>
					<center>
					<a href="<?= base_url('toko/input-more-info') ?>" class="btn btn-primary">Lanjut</a>
					</center>
					
				<?php else : ?>
					<span class='login100-form-title p-b-49'>Konfirmasi Email Gagal</span>
					<p><?= session('error') ?></p>
				<?php endif ?>
			</div>
		</div>

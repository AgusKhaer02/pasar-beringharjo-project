            ...
            <aside class="col-lg-6">
                <!-- <div class="border rounded-4 mb-3 d-flex justify-content-center">
                    <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="">
                        <img style="max-width: 100%; max-height: 100vh; margin: auto; object-fit:cover;" class="rounded-4" src="" />
                    </a>
                </div>
            ...
            <main class="col-lg-6">
                <div class="ps-lg-3">
                    ...
                    <div class="d-flex flex-row my-3">
                        ...
                        <span class="<?= ($produk['stok'] == "tersedia") ? 'text-success' : 'text-secondary' ?> ms-2">Stok <?= $produk['stok'] ?></span>
                    </div>

                    <div class="mb-3">
                        <span class="h2">Rp <?= $produk['harga']; ?></span>
                    </div>
